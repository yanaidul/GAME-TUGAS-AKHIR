...
public class LampuSpeechRecognition : MonoBehaviour
{
    ...
    public TextMeshProUGUI _answerTextBenar;
    public TextMeshProUGUI _answerTextSalah;
    ...
    void Update()
    {
        ...
        {
            _lampuQuestionManager._isAnswering = false;
            _isShowingCorrectResult = false;
            _lampuQuestionManager.SetResult(true);
            _answerTextBenar.SetText(message);
        }
        ...
        if (_isShowingIncorrectResult)
        {
            ...
            _answerTextSalah.SetText(message);
        }
        ...
        lock (threadLocker)
        {
            if (startRecoButton != null)
            {
                ...
                if (!waitingForReco && micPermissionGranted && _lampuQuestionManager._isAnswering) ButtonClick();
            }
            if (_message != null)
            {
                _message = message;
